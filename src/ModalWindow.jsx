            ...
            >
                ...
                <div className="flex">
                    ...
                    <div className="ml-auto mt-auto">
                        <button
                            type="submit"
                            className={`m-2 rounded border-none px-8 py-4 text-xl font-bold bg-blue-600 text-white transition duration-100 ${isSubmitDisabled ? "brightness-50" : "hover:brightness-125 active:brightness-75"}`}
